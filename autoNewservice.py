...
def setup_fastapi_container(repo_url=None, repo_folder=None, app_module=None, 
                          base_port=8000, container_name="fastapi-app", 
                          image_name="fastapi-app", project_dir=None, 
                          show_logs=False, follow_logs=False):
    """
...
def main():
    ...
    if result['success']:
        ...
        print("💡 Tip: Use Ctrl+C to stop log following, but the container will keep running")
